...
for ($f = 0; $f < count($feed_row); $f++) {
	...
	dict_row('<a class="favicon-16" href="/reader/' . $feed_row[$f]["slug"] . '/edit" style="background-image: url(/pub/favicon/' . crypt_crockford_encode($feed_row[$f]["feed_id"]) . '.png)">' . $feed_row[$f]["name"] . '</a>', '<a class="icon-16 minus-16" href="/reader/' . $feed_row[$f]["slug"] . '/remove">Remove</a>');
}
dict_end();
...
for ($t = 0; $t < count($topic_row); $t++) {
	...
	dict_row('<a class="icon-16 ' . $topic_row[$t]["icon"] . '-16" href="/reader/topic/' . $topic_row[$t]["slug"] . '/edit">' . $topic_row[$t]["name"] . '</a>', '<a class="icon-16 minus-16" href="/reader/topic/' . $topic_row[$t]["slug"] . '/remove">Remove</a>');
...
box_right('<a class="icon-16 feed-16" href="../add">Add Feed</a> | <a class="icon-16 news-16" href="add">Add Topic</a> | <a class="icon-16 opml-16" href="../export">Export</a>');
